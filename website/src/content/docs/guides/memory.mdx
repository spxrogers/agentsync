...
| Cursor (planned) | `AGENTS.md` |

Memory is **✓ native** on Claude and OpenCode — it carries across with full
fidelity. See the [capability matrix](/reference/capability-matrix/) for the
planned agents.
