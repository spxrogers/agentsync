...
All five valid agents — `claude`, `opencode`, `codex`, `cursor`, and `gemini` —
have real adapters and register normally. (`AGENTSYNC_ALLOW_UNIMPLEMENTED=1` exists
only for a hypothetical future agent registered as a no-op; none is today.)
