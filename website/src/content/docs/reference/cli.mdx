...
|---|---|---|
| `--scope user\|project` | init, verify, import, apply, status, diff, reconcile, explain, migrate, plugin upgrade | Force the config scope. |
| `--project <path>` | init, verify, import, apply, status, diff, reconcile, explain, migrate, plugin upgrade | Target / apply a specific project's tree. |
