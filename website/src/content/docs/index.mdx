...
hero:
  ...
  # applying out to the ten deep adapters + the 22-agent breadth tier (32 total —
...
| **Grok Build** | ✓ adapter | MCP (◐, TOML), instructions, complete skills, commands (◐), and command hooks (◐) at user and project scopes. [Supported paths and limits](https://github.com/spxrogers/agentsync/blob/main/docs/grok.md). Subagent/LSP projection and plugin import deferred. |
...
<Aside type="caution" title="Status: beta">
	v1.0 ships 32 agents — ten deep adapters (Claude, OpenCode, Codex, Cursor, Gemini, Continue, Windsurf, Roo, Cline, Grok Build) plus a 22-agent breadth tier — end-to-end. The tool is
