...
// TestNormalizeDir_CaseFold exercises the platform case-fold on every OS by
...
func TestNormalizeDir_CaseFold(t *testing.T) {
	...
	if !SameDir("/Users/Alice", "/users/alice") {
		t.Fatal("with the fold on, /Users/Alice and /users/alice must be one directory")
	}
	if !ContainsDir("/Users/Alice", "/users/alice/.grok") {
