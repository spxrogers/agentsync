...
// checkRun is the body of `agentsync check`, lifted out of the command literal:
// a hundred lines of scope resolution, source loading, agent-name validation and
// two-layer reference checking read as a function, not as a closure the reader
// has to scroll past to find the flags.
