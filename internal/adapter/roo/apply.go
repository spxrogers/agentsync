...
// applyWrite performs the per-op merge (for the merge-json-keys .roo/mcp.json) and
// hands post-merge bytes to the writer; rules/commands are whole-file replace.
