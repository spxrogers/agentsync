...
|---|---|:--:|:--:|:--:|:--:|:--:|:--:|:--:|---|---|
| ⭐️ **agentsync** ⭐️ *(this tool)* | **Go** | 8 (Claude, OpenCode, Codex, Cursor, Gemini, Continue, Windsurf, Roo; more planned) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ **3-state classifier + `reconcile`/`import` capture** | ✅ **age vault, `${secret:}`/`${env:}`, re-ref + leak backstop** |
