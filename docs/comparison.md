...
|---|---|:--:|:--:|:--:|:--:|:--:|:--:|:--:|---|---|
| ⭐️ **agentsync** ⭐️ *(this tool)* | **Go** | 7 (Claude, OpenCode, Codex, Cursor, Gemini, Continue, Windsurf; more planned) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ **3-state classifier + `reconcile`/`import` capture** | ✅ **age vault, `${secret:}`/`${env:}`, re-ref + leak backstop** |
